                ...
                <ul>
                    <li>
                        <a href="manage_classes.php">
                            <span class="title"><i class="entypo-dot"></i>Class List</span>
                        </a>
                    </li>
                ...
                <ul>
                    <li>
                        <a href="manage_subjects.php">
                            <span class="title"><i class="entypo-dot"></i>Subject List</span>
                        </a>
                    </li>
                    <li>
                        <a href="subject_assignment.php">
                            <span class="title"><i class="entypo-dot"></i>Subject Combination List</span>
                        </a>
                    </li>
                </ul>
            </li>
