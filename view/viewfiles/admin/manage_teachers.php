                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                ...
                                <!--  PROFILE LINK -->
                                <li>
                                    <a href="teacher_view.php?teacher_id=<?php echo  $oneData->teacher_id  ?>">
                                        <i class="entypo-user"></i>profile</a>
                                </li>

                                <!--  EDITING LINK -->
                                <li>
                                    <a href="teacher_edit.php?teacher_id=<?php echo  $oneData->teacher_id  ?>">
                                ...
                                <!--  DELETION LINK -->
                                <li>
                                    <a onclick='return doConfirm()' href="teacher_delete.php?teacher_id=<?php echo $oneData->teacher_id  ?>" ><i class="entypo-trash"></i>delete</a>
                                </li>
                            </ul>
                        </div>
                    </td>
