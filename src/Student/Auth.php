...
class Auth extends Database
{
    ...
    public function is_registered(){
        $query = "SELECT * FROM students WHERE email='$this->email' AND password='$this->password'";
    ...
    public function view() {
        $sqlQuery = "SELECT * FROM students WHERE email = '".$this->email."'";
    ...
    public function update() {
        ...
        $sqlQuery = "UPDATE students SET name = ?,email = ?, photo = ? WHERE email='".$this->email."'";
